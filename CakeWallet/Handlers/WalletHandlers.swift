            ...
            do {
                ...
                let password = try KeychainStorageImpl.standart.fetch(
                    forKey: KeychainKey.walletPassword(
                        WalletIndex(name: name, type: .triton)
                    )
                )
...
////
//                store.dispatch(
//                    WalletActions.restoreFromSeed(withName: name, andSeed: seed, restoreHeight: height, type: .triton, handler: compHandler)
//                )
...
//                    from: height,
//                    password: try KeychainStorageImpl.standart.fetch(forKey: KeychainKey.walletPassword(WalletIndex(name: moneroWallet.name, type: .triton))),
//                    node: node)
//                handler(
